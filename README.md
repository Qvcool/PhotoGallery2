...
|Scroll Delay|The amount of time, in milliseconds, that a slide is shown before the gallery presents the next slide. If `autoScroll` is set to `false`, this setting does nothing.|`scrollDelay: [delay in milliseconds]`|Positive number|`6000`|
